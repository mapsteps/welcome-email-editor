...
V4.9 - 14/12/18 - A version bump. Fixed a couple of outdated functions and added a settings function. Watch this space for more updates!

V4.9.1 - 17/12/18 
- PHP7+ support, removing create_function calls
- Removed reference to mysql_real_escape_string replacing with esc_sql instead

V4.9.2 - 07/04/20 
- It's been a while. A little refresh and new face to the plugin is coming VERY soon
- Modernised styles
- Added CSS/SCSS file

== Installation ==

1. Upload the ZIP file to the plugins page of your website
2. Activate the plugin
3. Visit the admin page it creates at the bottom of the admin menu
